...
dependent variables, outcome variable, output variable 
2. What are at least 3 names for the X values
independent variable, input variable, predictors, factors
...
1. the directional relationship between the two variables
2. strength of the relationship between the two variables
...
3. The full (model) formula for the model: Sepal.Length ~ Sepal.Width + Petal.Length + Petal.Width
